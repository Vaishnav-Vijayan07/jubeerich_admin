...
export const initialState = {
  ...
  password: "",
  updated_by: "",
  role_id: franchise_counsellor_id,
...
const FranchiseDetails = withSwal((props: any) => {
  const { swal } = props;
  ...
  const {
    ...
    initialLoading,
    countries: Countries,
    franchiseCounsellor: franchiseCounsellorData,
    franchiseCounsellorTL: franchiseCounsellorTLData,
    ...
    franchiseCounsellor: state.Users?.franchiseCounsellor,
    franchiseCounsellorTL: state.Users?.franchiseCounsellorTL,
  }));
  ...
  useEffect(() => {
    ...
    getFranchiseDetails();
    dispatch(getFranchiseCounsellors(franchiseId));
    dispatch(getFranchiseCounsellorsTL(franchiseId));
  }, [franchiseId]);

  useEffect(() => {
    const tlData = Array.isArray(franchiseCounsellorTLData) ? franchiseCounsellorTLData : [];
    const counsellorData = Array.isArray(franchiseCounsellorData) ? franchiseCounsellorData : [];

    setTableData([...tlData, ...counsellorData]);
  }, [franchiseCounsellorTLData, franchiseCounsellorData]);
                ...
                <Card.Body>
                  ...
                  <div className="text-start mt-3">
                    ...
                    <p className="text-muted mb-2 font-13">
                      ...
                      <span className="ms-2">{franchiseDetails?.phone}</span>
                    </p>
                    <p className="text-muted mb-2 font-13">
                      <strong>Email :</strong>
                      <span className="ms-2 ">{franchiseDetails?.email}</span>
                    </p>
            ...
            <Col md={8} lg={8}>
              <div className="d-flex justify-content-end pb-2">
                ...
                >
                  ...
                  <span className="ms-1">Franchise Counsellor</span>
                </Button>
                <Button
          ...
          <Row className="justify-content-between px-2">
            <Modal show={showModal} onHide={toggleModal} dialogClassName={"modal-right"}>
              <h6 className="fw-medium px-3 m-0 py-2 font-13 text-uppercase bg-light">
                <span className="d-block py-1">Add Franchise Counsellor {isTL ? "TL" : ""}</span>
              </h6>
              <Modal.Body>
                <Row>
