        ...
        <>
            ...
            <Card className="bg-white">
                ...
                <Modal show={showLetterModal} onHide={toggleLetterModal} size="lg" dialogClassName="modal-dialog-centered">
                    ...
                    <Modal.Footer>
                        <Button className="btn-danger waves-effect waves-light" onClick={() => [toggleLetterModal(), setSelectedFile(null), setSelectedOfferType(null)]}>
                            Close
                        </Button>
                        <Button className="btn-success waves-effect waves-light" disabled={(selectedFile == null || selectedOfferType == null)} onClick={handleOfferSubmit}>
                            Submit
                        </Button>
                    </Modal.Footer>
                </Modal>
