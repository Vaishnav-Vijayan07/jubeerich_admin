  ...
  const RemarkSection = ({ type }: any) => {
    return (
      <>
        ...
        <p className="remark-button-section cursor-pointer">Remarks</p>
      </>
    );
  };
      ...
      <div style={{ marginLeft: "20px", marginRight: "20px" }}>
        ...
        <Row className="mt-3">
          ...
          <Col md={11} className="pe-0" style={{ minHeight: "51px", maxHeight: "51px", paddingLeft: "0px" }}>
            <Button className="h-100 w-100 d-flex jsutify-content-start align-items-center" style={{ ...summaryHeaderStyle }}>
              <span className=" ps-3 font-18 fw-semibold">Summary</span>
            </Button>
          </Col>
        </Row>
              ...
              <Row>
                ...
                >
                  {entryRequirementTabsData.map((tab) => (
                    <Tab key={tab.value} value={tab.value} label={tab.label} sx={{ ...individualTabStyle }} />
                  ))}
                </Tabs>
                          ...
                          {summaryData?.educationCheck?.map((data: any) => (
                            <div style={{ ...educationCheckStyles }}>
                              <div className="ps-2 pt-2">
                                <p className="fs-14 fw-semibold" style={{ lineHeight: "18px" }}>
            ...
            >
              <Row>
                <Tabs
                  ...
                  sx={{ ...tabsStyle }}
                >
                  {quantityTabItems.map(
                    (tab) =>
                      quantityTabValue === tab.value && (
                        <Tab key={tab.value} value={tab.value} label={tab.label} sx={{ ...individualTabStyleCustom }} />
                      )
                  )}
                </Tabs>
