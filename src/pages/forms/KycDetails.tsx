...
const KycDetails = withSwal((props: any) => {
    ...
    () =>
      response
        ? [
            ...
            {
              label: "DOB",
              value: response?.basicInfoDetails?.dob ? moment(response?.basicInfoDetails?.dob).format("DD/MM/YYYY") : "N/A",
            },
            ...
            { label: "Source of Lead", value: response?.leadSource?.source_name || "N/A" },
            {
              ...
              value: response?.studyPreferences?.[0]?.studyPreferenceDetails?.[0]?.preferred_courses?.course_name || "N/A",
            },
            {
              label: "Preferred Institute",
              value: response?.studyPreferences?.[0]?.studyPreferenceDetails?.[0]?.preferred_campus?.campus_name || "N/A",
            },
            {
              label: "Course Link",
    ...
    () =>
      response
        ? [
            ...
            {
              label: "Name of the company in which your Spouse is currently working",
              value: response?.familyDetails?.[0]?.spouse?.organization || "N/A",
            },
            ...
            {
              label: "Is your spouse accompanying along with you during studies?",
              value: response?.familyDetails?.[0]?.accompanying_spouse ? "Yes" : "No",
            },
            ...
            {
              label: "Are your kids accompanying along with you during studies?",
              value: response?.familyDetails?.[0]?.accompanying_child ? "Yes" : "No",
            },
            {
              label: "Do you have any relatives/friends from Govt. service, Police, Political party, Media?",
              value: response?.familyDetails?.[0]?.relatives_info || "N/A",
            },
          ]
        : [],
    [response]
    ...
    () =>
      response
        ? response?.passportDetails?.map((data: any) => [
            ...
            {
              label: "Any visa stamping/ immigration history in the current and previous passport?",
              value: data?.visa_immigration_history ? "Yes" : "No",
            },
  ...
  const employementHistoriesDetails = useMemo(
    () =>
      response
        ? [
            {
            ...
            {
              label: "Did you get terminated from any organization/company?",
              value: response?.userEmploymentHistories?.terminated_from_company ? "Yes" : "No",
            },
            {
              label: "Are you in very good and friendly relation with all of your previous/current employers?",
              value: response?.userEmploymentHistories?.good_relation_with_employers ? "Yes" : "No",
            },
            {
              label: "Is there any forged experience or any other documents submitted to us?",
              value: response?.userEmploymentHistories?.submitted_forged_documents ? "Yes" : "No",
            },
            {
              label:
    ...
    <div>
      <PageTitle
        breadCrumbItems={[
          ...
          { label: "KYC View", path: "/kyc_details/:id", active: true },
        ]}
        title={"KYC View"}
      />
                    ...
                    {fundDetails.length > 0 ? (
                      fundDetails?.map((data: any, index: any) => (
                        <div key={index} className={`mb-3 ${index % 2 === 0 ? "bg-light" : ""}`} style={{ padding: "10px", borderRadius: "4px" }}>
                          ...
                          {(data?.type == fdValue || data?.type == savingsValue) && (
                            <div>
                    ...
                    {visaDeclineDetails?.map((visa: any, index: any) => (
                      <div key={index} className={`mb-3 ${index % 2 === 0 ? "bg-light" : ""}`} style={{ padding: "10px", borderRadius: "4px" }}>
                        ...
                        <p className="mb-1 font-15">
                          ...
                          <span className="ms-2">
                            {visa?.declined_course?.course_name} - {visa?.declined_university_applied?.university_name}
                          </span>
                        </p>
                        <p className="mb-1 font-15">
                    ...
                    {visaApprovalDetails?.map((visa: any, index: any) => (
                      <div key={index} className={`mb-3 ${index % 2 === 0 ? "bg-light" : ""}`} style={{ padding: "10px", borderRadius: "4px" }}>
                        ...
                        <p className="mb-1 font-15">
                          <strong>Course and Institute Applied For:</strong>
                          <span className="ms-2">
                            {visa?.approved_course?.course_name} - {visa?.approved_university_applied?.university_name}
                          </span>
                        </p>
                        <p className="mb-1 font-15">
                    ...
                    {travelHistoryDetails?.map((travel: any, index: number) => (
                      <div key={index} className={`mb-3 ${index % 2 === 0 ? "bg-light" : ""}`} style={{ padding: "10px", borderRadius: "4px" }}>
                        ...
                        <p className="mb-1 font-15">
                          ...
                          <span className="ms-2">
                            {travel?.start_date ? moment(travel?.start_date).format("DD/MM/YYYY") : "N/A"} -{" "}
                            {travel?.end_date ? moment(travel?.end_date).format("DD/MM/YYYY") : "N/A"}
                          </span>
                        </p>
                        <p className="mb-1 font-15">
      ...
      {!hideFooter && userRole == country_manager_id && (
        <Row>
          <Col>
          ...
          <div className="d-flex justify-content-end gap-3">
            <Button variant="danger" onClick={rejectKYC}>
              Reject
            </Button>
