          ...
          <Form onSubmit={onSubmit}>
            ...
            <Modal.Body>
              <Form.Group controlId="validationCustom01">
                ...
                <Form.Control type="text" name="task_prefix" value={formData.task_prefix} onChange={handleInputChange} />
                {validationErrors.task_prefix && <Form.Text className="text-danger">{validationErrors.task_prefix}</Form.Text>}
              </Form.Group>
            </Modal.Body>
            <Modal.Footer>
...
const TaskPrefix = () => {
  ...
  return (
    <React.Fragment>
      ...
      <Row>
        <Col>
          <BasicInputElements state={prefixData} loading={isLoading} getTaskPrefix={getTaskPrefix} />
        </Col>
      </Row>
    </React.Fragment>
  );
