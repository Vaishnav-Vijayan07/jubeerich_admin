                        ...
                        <Row>
                            <Col md={6} lg={6} xl={6} xxl={4}>
                                ...
                                <div className='d-flex'>
                                    ...
                                    >
                                        <div className=' p-1'>
                                            {(documentsName?.passport_doc ? 'Passport Document' : "")}
                                        </div>
                                    </a>}
                                    {documentsName?.passport_doc && <i onClick={() => deleteAdditionalDoc('passport_doc')} className='mdi mdi-delete mt-1 ps-1'></i>}
                                </div>
                            </Col>
                            ...
                            <Col md={6} lg={6} xl={6} xxl={4}>
                                ...
                                <div className='d-flex'>
                                    ...
                                    >
                                        <div className=' p-1'>
                                            {(documentsName?.updated_cv ? "Updated CV" : "")}
                                        </div>
                                    </a>}
                            ...
                            <Col md={6} lg={6} xl={6} xxl={4}>
                                ...
                                <div className='d-flex'>
                                    {documentsName?.profile_assessment_doc && <a
                                    ...
                                    {documentsName?.profile_assessment_doc && <i onClick={() => deleteAdditionalDoc('profile_assessment_doc')} className='mdi mdi-delete mt-1 ps-1'></i>}
                                </div>
                            </Col>
