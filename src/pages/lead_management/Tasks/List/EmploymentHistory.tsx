      ...
      <Row className='mt-3'>
        ...
        <Col md={6} lg={6} xl={6} xxl={4}>
          ...
          <div className='d-flex mb-2'>
            ...
            >
              <div className=' p-1'>
                {(documentsName?.visa_page ? "Visa Page" : "")}
              </div>
            </a>}
          </div>
        </Col>
        ...
        <Col md={6} lg={6} xl={6} xxl={4}>
          ...
          <div className='d-flex mb-2'>
            ...
            >
              <div className=' p-1'>
                {(documentsName?.permit_card ? "Permit Card" : "")}
              </div>
            </a>}
          </div>
        </Col>
        ...
        <Col md={6} lg={6} xl={6} xxl={4}>
          ...
          <div className='d-flex mb-2'>
            {documentsName?.salary_account_statement && <a
            ...
            >
              <div className=' p-1'>
                {(documentsName?.salary_account_statement ? "Salary Account Statement" : "")}
              </div>
            </a>}
          </div>
        </Col>
        ...
        <Col md={6} lg={6} xl={6} xxl={4}>
          ...
          <div className='d-flex mb-2'>
            {documentsName?.supporting_documents && <a
            ...
            >
              <div className=' p-1'>
                {(documentsName?.supporting_documents ? "Supporting Documents" : "")}
              </div>
            </a>}
          </div>
        </Col>

        <Button className="mt-1" onClick={onSubmit}>Save Experience History</Button>
      </Row>
    </>
  )
}
